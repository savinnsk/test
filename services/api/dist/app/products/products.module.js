...
const create_product_service_1 = require("./usecases/create-product/create-product.service");
...
ProductsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...usecases_1.default, create_product_service_1.CreateProductService],
        exports: [...usecases_1.default, create_product_service_1.CreateProductService],
    })
], ProductsModule);
