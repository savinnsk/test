...
let TerminusModule = TerminusModule_1 = class TerminusModule {
    static forRoot(options = { errorLogStyle: 'json' }) {
        return {
            module: TerminusModule_1,
            providers: [...providers, (0, error_logger_provider_1.getErrorLoggerProvider)(options.errorLogStyle)],
            exports: exports_,
        };
    }
};
TerminusModule = TerminusModule_1 = __decorate([
    (0, common_1.Module)({
        providers: [...providers, (0, error_logger_provider_1.getErrorLoggerProvider)()],
        exports: exports_,
    })
], TerminusModule);
